package com.jtrent238.avengers.blocks;
...
public class BlockModWeb extends Block implements net.minecraftforge.common.IShearable
{
	String RegistryName = "BlockModWeb";
