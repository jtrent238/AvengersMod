package com.jtrent238.avengers.entity;
...
public class EntityWeb extends Entity implements IProjectile
{
    ...
    public EntityWeb(World worldIn, EntityLivingBase shooter)
    {
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            {
                this.onHit(raytraceresult, blockpos);
            }
     ...
     * @param pos 
     */
	protected void onHit(RayTraceResult raytraceResultIn, Vec3i pos)
    {
